...
class ResourceProvider with ChangeNotifier {
  ...
  List<Resource> get videos => _resources.where((resource) => resource.type == ResourceType.video).toList();

  List<Resource> get studyGuides => _resources.where((resource) => resource.type == ResourceType.studyGuide).toList();
